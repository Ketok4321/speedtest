...
# very slightly modified version of https://github.com/sivel/speedtest-cli/
# TODO: licensing. does this count as derivative work? can i relicense it?
    ...
    def download(self, callback=do_nothing, threads=None):
        ...
        def consumer(q, request_count):
            ...
            while len(finished) < request_count:
                ...
                speed = sum(finished) / (timeit.default_timer() - start) * 8.0
                callback(thread.i, request_count, end=True, speed=speed)
